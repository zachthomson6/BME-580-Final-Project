...
# Calculate accuracy
accuracyf1 = (tabknnf1[1]+tabknnf1[4]) / nrow(test_data)
accuracyf2 = (tabknnf2[1]+tabknnf2[4]) / nrow(test_data)
accuracyf3 = (tabknnf3[1]+tabknnf3[4]) / nrow(test_data)
accuracyf4 = (tabknnf4[1]+tabknnf4[4]) / nrow(test_data)
...
#GAMS
```{r}
gamMod = gam(ADCDRSTG ~ s(DecisionMaking) + s(Arithmetic) + s(MMSE_score), data = train_data)
summary(gamMod)
```

# Section 3: Model Evaluation Criteria (Cp, AIC, BIC)
