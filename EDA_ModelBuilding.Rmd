...
# Isolate first 13 principal components
pca_var = data.frame(pca.loadings[,1:13])

poly_reg <- polr(train_data$ADCDRSTG ~ .^2, data=data.frame(pca_var, train_data$ADCDRSTG), Hess=TRUE)
