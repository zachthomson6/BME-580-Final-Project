...
confusionTab = table(Predicted = ldaPred$class,
                      Actual = train_data$ADCDRSTG)
confusionTab

# create confusion matrix for test set
ldaPred_test = predict(ldaMod, test_data)
confusionTab_test = table(Predicted = ldaPred_test$class,
...
#KNN
```{r}
knn3 = knn(train_data, test_data, cl = as.factor(train_data$ADCDRSTG), k = 3)
tab3 = table(knn5,as.factor(test_data$ADCDRSTG))
tab3
```
