...
legend("topright", legend = c("0", "0.5", "1", "1.5", "2", "3"), fill = c("1", "2", "3", "4", "5", "6"), cex=0.8)
```
...
fviz_pca_biplot(pca, habillage = train_data$ADCDRSTG, geom="point")
fviz_pca_ind(pca,
              col.ind = 'coord',
             geom="point",
